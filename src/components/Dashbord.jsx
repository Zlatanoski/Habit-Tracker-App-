                    ...
                    <div className="mt-8 pt-6 border-t border-slate-700/50">
                        <div className="mb-6">
                            <div className="flex items-center justify-between mb-4">
                                <h2 className="text-lg font-semibold text-slate-200">Streaks</h2>
                                ...
                                {habits.map((habit) => (
                                    ...
                                    >
                                        <div className="flex items-center space-x-2 mb-2">
                                            ...
                                            <span className="font-medium text-white text-xs">{habit.name}</span>
                                        </div>
                            ...
                            <div className="mt-4 pt-4 border-t border-slate-700/50">
                                <h3 className="text-xs font-medium text-slate-400 mb-3">Quick Stats</h3>
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            <TrophyIcon className="w-3 h-3 text-amber-400" />
                                            <span className="text-xs text-slate-300">Best</span>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-xs font-semibold text-white">{habits.length}</span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            <FireIcon className="w-3 h-3 text-emerald-400" />
