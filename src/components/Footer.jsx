...
const Footer = () => {
    return (
        <footer className="w-full border-t-2 border-gray-500 bg-brandDark flex justify-center py-6 sm:py-8 mt-20">
            <div className="max-w-6xl mx-auto grid grid-cols-3 gap-6 sm:gap-12 text-center md:text-left">
                ...
                <div className="space-y-1 sm:space-y-2">
                    ...
                    <a href="" className="block text-brandWhite text-sm sm:text-base hover:underline">Twitter</a>
